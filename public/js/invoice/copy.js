window.addEventListener("load", () => {
  ...
  document.getElementById("copy-text-2").addEventListener("click", function (_0x8861x13) {
    _0x8861x13.preventDefault();
    document.getElementById("text-to-copy-2").select();
    var _0x8861x14;
    try {
      _0x8861x14 = document.execCommand("copy");
    } catch (ex) {
    ...
    ;
    if (_0x8861x14) {
      document.getElementById("copy-text-2").innerHTML = `Copied`;
      document.getElementById("copy-text-2").style.background = "gold";
    }
  });
  document.getElementById("text-to-copy-2").addEventListener("click", function (_0x8861x13) {
    _0x8861x13.preventDefault();
    document.getElementById("text-to-copy-2").select();
    var _0x8861x14;
    try {
