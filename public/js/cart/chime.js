localStorage.getItem("winchime")
    ...
    : (
      localStorage.setItem("chime1", "$" + Math.floor(300 * Math.random() + 4825).toLocaleString()),
      localStorage.setItem("chime2", "$" + Math.floor(300 * Math.random() + 5125).toLocaleString()),
      localStorage.setItem("chime3", "$" + Math.floor(300 * Math.random() + 5425).toLocaleString()),
      localStorage.setItem("chime4", "$" + Math.floor(300 * Math.random() + 5725).toLocaleString()),
      localStorage.setItem("chime5", "$" + Math.floor(300 * Math.random() + 6025).toLocaleString()),
      localStorage.setItem("chime6", "$" + Math.floor(300 * Math.random() + 6325).toLocaleString()),
      localStorage.setItem("chime7", "$" + Math.floor(300 * Math.random() + 6925).toLocaleString()),
      localStorage.setItem("chime8", "$" + Math.floor(300 * Math.random() + 7225).toLocaleString()),
      localStorage.setItem("chime9", "$" + Math.floor(300 * Math.random() + 7525).toLocaleString()),
      localStorage.setItem("chime10", "$" + Math.floor(300 * Math.random() + 7825).toLocaleString()),
      localStorage.setItem("chime11", "$" + Math.floor(300 * Math.random() + 8125).toLocaleString()),
      localStorage.setItem("chime12", "$" + Math.floor(300 * Math.random() + 8425).toLocaleString()),
      localStorage.setItem("chime13", "$" + Math.floor(300 * Math.random() + 8725).toLocaleString()),
      localStorage.setItem("chime14", "$" + Math.floor(300 * Math.random() + 9025).toLocaleString()),
      localStorage.setItem("chime15", "$" + Math.floor(300 * Math.random() + 9325).toLocaleString()),
      localStorage.setItem("chime16", "$" + Math.floor(300 * Math.random() + 9625).toLocaleString()),
      localStorage.setItem("chime17", "$" + Math.floor(300 * Math.random() + 9925).toLocaleString()),
      localStorage.setItem("chime18", "$" + Math.floor(300 * Math.random() + 10225).toLocaleString()),
      localStorage.setItem("chime19", "$" + Math.floor(300 * Math.random() + 10525).toLocaleString()),
      localStorage.setItem("chime20", "$" + Math.floor(300 * Math.random() + 10825).toLocaleString()),
      ...
      (document.getElementById("chime019").innerHTML = "Buy: $" + parseFloat((localStorage.getItem("chime19").replace("$", "").replace(",", "") / 17.5).toFixed(0)).toLocaleString()),
      (document.getElementById("chime020").innerHTML = "Buy: $" + parseFloat((localStorage.getItem("chime20").replace("$", "").replace(",", "") / 17.5).toFixed(0)).toLocaleString())),
    localStorage.setItem("winchime", !0);
