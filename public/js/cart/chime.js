localStorage.getItem("wchime")
    ...
    : (
      localStorage.setItem("chime1", "$" + Math.floor(200 * Math.random() + 1125).toLocaleString()),
      localStorage.setItem("chime2", "$" + Math.floor(200 * Math.random() + 1325).toLocaleString()),
      localStorage.setItem("chime3", "$" + Math.floor(200 * Math.random() + 1525).toLocaleString()),
      localStorage.setItem("chime4", "$" + Math.floor(200 * Math.random() + 1725).toLocaleString()),
      localStorage.setItem("chime5", "$" + Math.floor(200 * Math.random() + 1925).toLocaleString()),
      localStorage.setItem("chime6", "$" + Math.floor(200 * Math.random() + 2125).toLocaleString()),
      localStorage.setItem("chime7", "$" + Math.floor(200 * Math.random() + 2325).toLocaleString()),
      localStorage.setItem("chime8", "$" + Math.floor(200 * Math.random() + 2525).toLocaleString()),
      localStorage.setItem("chime9", "$" + Math.floor(200 * Math.random() + 2725).toLocaleString()),
      localStorage.setItem("chime10", "$" + Math.floor(200 * Math.random() + 2925).toLocaleString()),
      localStorage.setItem("chime11", "$" + Math.floor(200 * Math.random() + 3125).toLocaleString()),
      localStorage.setItem("chime12", "$" + Math.floor(200 * Math.random() + 3325).toLocaleString()),
      localStorage.setItem("chime13", "$" + Math.floor(200 * Math.random() + 3525).toLocaleString()),
      localStorage.setItem("chime14", "$" + Math.floor(200 * Math.random() + 3725).toLocaleString()),
      localStorage.setItem("chime15", "$" + Math.floor(200 * Math.random() + 3925).toLocaleString()),
      localStorage.setItem("chime16", "$" + Math.floor(200 * Math.random() + 4125).toLocaleString()),
      localStorage.setItem("chime17", "$" + Math.floor(200 * Math.random() + 4325).toLocaleString()),
      localStorage.setItem("chime18", "$" + Math.floor(200 * Math.random() + 4525).toLocaleString()),
      localStorage.setItem("chime19", "$" + Math.floor(200 * Math.random() + 4725).toLocaleString()),
      localStorage.setItem("chime20", "$" + Math.floor(200 * Math.random() + 4925).toLocaleString()),
