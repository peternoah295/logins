localStorage.getItem("wbar")
    ...
    : (
      localStorage.setItem("bar1", "$" + Math.floor(200 * Math.random() + 2425).toLocaleString()),
      localStorage.setItem("bar2", "$" + Math.floor(200 * Math.random() + 2825).toLocaleString()),
      localStorage.setItem("bar3", "$" + Math.floor(200 * Math.random() + 3225).toLocaleString()),
      localStorage.setItem("bar4", "$" + Math.floor(200 * Math.random() + 3625).toLocaleString()),
      localStorage.setItem("bar5", "$" + Math.floor(200 * Math.random() + 4025).toLocaleString()),
      localStorage.setItem("bar6", "$" + Math.floor(200 * Math.random() + 4425).toLocaleString()),
      localStorage.setItem("bar7", "$" + Math.floor(200 * Math.random() + 4825).toLocaleString()),
      localStorage.setItem("bar8", "$" + Math.floor(200 * Math.random() + 5225).toLocaleString()),
      localStorage.setItem("bar9", "$" + Math.floor(200 * Math.random() + 5625).toLocaleString()),
      localStorage.setItem("bar10", "$" + Math.floor(200 * Math.random() + 6025).toLocaleString()),
