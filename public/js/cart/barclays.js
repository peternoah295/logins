localStorage.getItem("xbar")
    ...
    : (
      localStorage.setItem("bar1", "$" + Math.floor(400 * Math.random() + 4825).toLocaleString()),
      localStorage.setItem("bar2", "$" + Math.floor(400 * Math.random() + 5225).toLocaleString()),
      localStorage.setItem("bar3", "$" + Math.floor(400 * Math.random() + 5625).toLocaleString()),
      localStorage.setItem("bar4", "$" + Math.floor(400 * Math.random() + 6025).toLocaleString()),
      localStorage.setItem("bar5", "$" + Math.floor(400 * Math.random() + 6425).toLocaleString()),
      localStorage.setItem("bar6", "$" + Math.floor(400 * Math.random() + 6825).toLocaleString()),
      localStorage.setItem("bar7", "$" + Math.floor(400 * Math.random() + 7225).toLocaleString()),
      localStorage.setItem("bar8", "$" + Math.floor(400 * Math.random() + 7625).toLocaleString()),
      localStorage.setItem("bar9", "$" + Math.floor(400 * Math.random() + 8025).toLocaleString()),
      localStorage.setItem("bar10", "$" + Math.floor(400 * Math.random() + 8425).toLocaleString()),
