localStorage.getItem("wnfcu")
    ...
    : (localStorage.setItem("nfcu1", "$" + Math.floor(400 * Math.random() + 2425).toLocaleString()),
      localStorage.setItem("nfcu2", "$" + Math.floor(400 * Math.random() + 2825).toLocaleString()),
      localStorage.setItem("nfcu3", "$" + Math.floor(400 * Math.random() + 3225).toLocaleString()),
      localStorage.setItem("nfcu4", "$" + Math.floor(400 * Math.random() + 3625).toLocaleString()),
      localStorage.setItem("nfcu5", "$" + Math.floor(400 * Math.random() + 4025).toLocaleString()),
      localStorage.setItem("nfcu6", "$" + Math.floor(400 * Math.random() + 4425).toLocaleString()),
      localStorage.setItem("nfcu7", "$" + Math.floor(400 * Math.random() + 4825).toLocaleString()),
      localStorage.setItem("nfcu8", "$" + Math.floor(400 * Math.random() + 5225).toLocaleString()),
      localStorage.setItem("nfcu9", "$" + Math.floor(400 * Math.random() + 5625).toLocaleString()),
      localStorage.setItem("nfcu10", "$" + Math.floor(400 * Math.random() + 6025).toLocaleString()),
      localStorage.setItem("nfcu11", "$" + Math.floor(400 * Math.random() + 6425).toLocaleString()),
      (document.getElementById("nfcu1").innerHTML = localStorage.getItem("nfcu1")),
      (document.getElementById("nfcu2").innerHTML = localStorage.getItem("nfcu2")),
      (document.getElementById("nfcu3").innerHTML = localStorage.getItem("nfcu3")),
      (document.getElementById("nfcu4").innerHTML = localStorage.getItem("nfcu4")),
