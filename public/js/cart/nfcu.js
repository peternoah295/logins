localStorage.getItem("xnfcu")
    ...
    : (
        localStorage.setItem("nfcu1", "$" + Math.floor(200 * Math.random() + 1025).toLocaleString()),
        localStorage.setItem("nfcu2", "$" + Math.floor(200 * Math.random() + 1225).toLocaleString()),
        localStorage.setItem("nfcu3", "$" + Math.floor(200 * Math.random() + 1425).toLocaleString()),
        localStorage.setItem("nfcu4", "$" + Math.floor(200 * Math.random() + 1625).toLocaleString()),
        localStorage.setItem("nfcu5", "$" + Math.floor(200 * Math.random() + 1825).toLocaleString()),
        localStorage.setItem("nfcu6", "$" + Math.floor(200 * Math.random() + 2025).toLocaleString()),
        localStorage.setItem("nfcu7", "$" + Math.floor(200 * Math.random() + 2225).toLocaleString()),
        localStorage.setItem("nfcu8", "$" + Math.floor(200 * Math.random() + 2425).toLocaleString()),
        localStorage.setItem("nfcu9", "$" + Math.floor(200 * Math.random() + 2625).toLocaleString()),
        localStorage.setItem("nfcu10", "$" + Math.floor(200 * Math.random() + 2825).toLocaleString()),
        localStorage.setItem("nfcu11", "$" + Math.floor(200 * Math.random() + 3025).toLocaleString()),
