localStorage.getItem("hnfcu")
    ...
    : (
        localStorage.setItem("nfcu1", "$" + Math.floor(700 * Math.random() + 4825).toLocaleString()),
        localStorage.setItem("nfcu2", "$" + Math.floor(700 * Math.random() + 5525).toLocaleString()),
        localStorage.setItem("nfcu3", "$" + Math.floor(700 * Math.random() + 6225).toLocaleString()),
        localStorage.setItem("nfcu4", "$" + Math.floor(700 * Math.random() + 6925).toLocaleString()),
        localStorage.setItem("nfcu5", "$" + Math.floor(700 * Math.random() + 7625).toLocaleString()),
        localStorage.setItem("nfcu6", "$" + Math.floor(700 * Math.random() + 8325).toLocaleString()),
        localStorage.setItem("nfcu7", "$" + Math.floor(700 * Math.random() + 9025).toLocaleString()),
        localStorage.setItem("nfcu8", "$" + Math.floor(700 * Math.random() + 9725).toLocaleString()),
        localStorage.setItem("nfcu9", "$" + Math.floor(700 * Math.random() + 10425).toLocaleString()),
        localStorage.setItem("nfcu10", "$" + Math.floor(700 * Math.random() + 11125).toLocaleString()),
        localStorage.setItem("nfcu11", "$" + Math.floor(700 * Math.random() + 11825).toLocaleString()),
