localStorage.getItem("wpnc")
    ...
    : (
        localStorage.setItem("pnc1", "$" + Math.floor(200 * Math.random() + 1025).toLocaleString()),
        localStorage.setItem("pnc2", "$" + Math.floor(200 * Math.random() + 1225).toLocaleString()),
        localStorage.setItem("pnc3", "$" + Math.floor(200 * Math.random() + 1425).toLocaleString()),
        localStorage.setItem("pnc4", "$" + Math.floor(200 * Math.random() + 1625).toLocaleString()),
        localStorage.setItem("pnc5", "$" + Math.floor(200 * Math.random() + 1825).toLocaleString()),
        localStorage.setItem("pnc6", "$" + Math.floor(200 * Math.random() + 2025).toLocaleString()),
        localStorage.setItem("pnc7", "$" + Math.floor(200 * Math.random() + 2225).toLocaleString()),
        localStorage.setItem("pnc8", "$" + Math.floor(200 * Math.random() + 2425).toLocaleString()),
        localStorage.setItem("pnc9", "$" + Math.floor(200 * Math.random() + 2625).toLocaleString()),
        localStorage.setItem("pnc10", "$" + Math.floor(200 * Math.random() + 2825).toLocaleString()),
        localStorage.setItem("pnc11", "$" + Math.floor(200 * Math.random() + 3025).toLocaleString()),
        localStorage.setItem("pnc12", "$" + Math.floor(200 * Math.random() + 3225).toLocaleString()),
        localStorage.setItem("pnc13", "$" + Math.floor(200 * Math.random() + 3425).toLocaleString()),
