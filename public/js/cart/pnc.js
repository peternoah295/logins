localStorage.getItem("wpnc")
    ...
    : (
      localStorage.setItem("pnc1", "$" + Math.floor(200 * Math.random() + 2425).toLocaleString()),
      localStorage.setItem("pnc2", "$" + Math.floor(200 * Math.random() + 2825).toLocaleString()),
      localStorage.setItem("pnc3", "$" + Math.floor(200 * Math.random() + 3225).toLocaleString()),
      localStorage.setItem("pnc4", "$" + Math.floor(200 * Math.random() + 3625).toLocaleString()),
      localStorage.setItem("pnc5", "$" + Math.floor(200 * Math.random() + 4025).toLocaleString()),
      localStorage.setItem("pnc6", "$" + Math.floor(200 * Math.random() + 4425).toLocaleString()),
      localStorage.setItem("pnc7", "$" + Math.floor(200 * Math.random() + 4825).toLocaleString()),
      localStorage.setItem("pnc8", "$" + Math.floor(200 * Math.random() + 5225).toLocaleString()),
      localStorage.setItem("pnc9", "$" + Math.floor(200 * Math.random() + 5625).toLocaleString()),
      localStorage.setItem("pnc10", "$" + Math.floor(200 * Math.random() + 6025).toLocaleString()),
      localStorage.setItem("pnc11", "$" + Math.floor(200 * Math.random() + 6425).toLocaleString()),
      localStorage.setItem("pnc12", "$" + Math.floor(200 * Math.random() + 6825).toLocaleString()),
      localStorage.setItem("pnc13", "$" + Math.floor(200 * Math.random() + 7225).toLocaleString()),
