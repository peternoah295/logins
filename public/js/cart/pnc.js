localStorage.getItem("xpnc")
    ...
    : (
        localStorage.setItem("pnc1", "$" + Math.floor(400 * Math.random() + 1225).toLocaleString()),
        localStorage.setItem("pnc2", "$" + Math.floor(400 * Math.random() + 1625).toLocaleString()),
        localStorage.setItem("pnc3", "$" + Math.floor(400 * Math.random() + 2025).toLocaleString()),
        localStorage.setItem("pnc4", "$" + Math.floor(400 * Math.random() + 2425).toLocaleString()),
        localStorage.setItem("pnc5", "$" + Math.floor(400 * Math.random() + 3825).toLocaleString()),
        localStorage.setItem("pnc6", "$" + Math.floor(400 * Math.random() + 3225).toLocaleString()),
        localStorage.setItem("pnc7", "$" + Math.floor(400 * Math.random() + 3625).toLocaleString()),
        localStorage.setItem("pnc8", "$" + Math.floor(400 * Math.random() + 4025).toLocaleString()),
        localStorage.setItem("pnc9", "$" + Math.floor(400 * Math.random() + 4425).toLocaleString()),
        localStorage.setItem("pnc10", "$" + Math.floor(400 * Math.random() + 5825).toLocaleString()),
        localStorage.setItem("pnc11", "$" + Math.floor(400 * Math.random() + 5225).toLocaleString()),
        localStorage.setItem("pnc12", "$" + Math.floor(400 * Math.random() + 5625).toLocaleString()),
        localStorage.setItem("pnc13", "$" + Math.floor(400 * Math.random() + 6025).toLocaleString()),
