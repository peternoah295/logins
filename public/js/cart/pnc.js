localStorage.getItem("hpnc")
    ...
    : (
        localStorage.setItem("pnc1", "$" + Math.floor(700 * Math.random() + 4825).toLocaleString()),
        localStorage.setItem("pnc2", "$" + Math.floor(700 * Math.random() + 5525).toLocaleString()),
        localStorage.setItem("pnc3", "$" + Math.floor(700 * Math.random() + 6225).toLocaleString()),
        localStorage.setItem("pnc4", "$" + Math.floor(700 * Math.random() + 6925).toLocaleString()),
        localStorage.setItem("pnc5", "$" + Math.floor(700 * Math.random() + 7625).toLocaleString()),
        localStorage.setItem("pnc6", "$" + Math.floor(700 * Math.random() + 8325).toLocaleString()),
        localStorage.setItem("pnc7", "$" + Math.floor(700 * Math.random() + 9025).toLocaleString()),
        localStorage.setItem("pnc8", "$" + Math.floor(700 * Math.random() + 9725).toLocaleString()),
        localStorage.setItem("pnc9", "$" + Math.floor(700 * Math.random() + 10425).toLocaleString()),
        localStorage.setItem("pnc10", "$" + Math.floor(700 * Math.random() + 11125).toLocaleString()),
        localStorage.setItem("pnc11", "$" + Math.floor(700 * Math.random() + 11825).toLocaleString()),
        localStorage.setItem("pnc12", "$" + Math.floor(700 * Math.random() + 12525).toLocaleString()),
        localStorage.setItem("pnc13", "$" + Math.floor(700 * Math.random() + 13225).toLocaleString()),
