localStorage.getItem("winpnc")
    ...
    : (
        localStorage.setItem("pnc1", "$" + Math.floor(300 * Math.random() + 4825).toLocaleString()),
        localStorage.setItem("pnc2", "$" + Math.floor(300 * Math.random() + 5125).toLocaleString()),
        localStorage.setItem("pnc3", "$" + Math.floor(300 * Math.random() + 5425).toLocaleString()),
        localStorage.setItem("pnc4", "$" + Math.floor(300 * Math.random() + 5725).toLocaleString()),
        localStorage.setItem("pnc5", "$" + Math.floor(300 * Math.random() + 6025).toLocaleString()),
        localStorage.setItem("pnc6", "$" + Math.floor(300 * Math.random() + 6325).toLocaleString()),
        localStorage.setItem("pnc7", "$" + Math.floor(300 * Math.random() + 6925).toLocaleString()),
        localStorage.setItem("pnc8", "$" + Math.floor(300 * Math.random() + 7225).toLocaleString()),
        localStorage.setItem("pnc9", "$" + Math.floor(300 * Math.random() + 7525).toLocaleString()),
        localStorage.setItem("pnc10", "$" + Math.floor(300 * Math.random() + 7825).toLocaleString()),
        localStorage.setItem("pnc11", "$" + Math.floor(300 * Math.random() + 8125).toLocaleString()),
        localStorage.setItem("pnc12", "$" + Math.floor(300 * Math.random() + 8425).toLocaleString()),
        localStorage.setItem("pnc13", "$" + Math.floor(300 * Math.random() + 8725).toLocaleString()),
