localStorage.getItem("xwood")
    ...
    : (
        localStorage.setItem("wood1", "$" + Math.floor(200 * Math.random() + 1025).toLocaleString()),
        localStorage.setItem("wood2", "$" + Math.floor(200 * Math.random() + 1225).toLocaleString()),
        localStorage.setItem("wood3", "$" + Math.floor(200 * Math.random() + 1425).toLocaleString()),
        localStorage.setItem("wood4", "$" + Math.floor(200 * Math.random() + 1625).toLocaleString()),
        localStorage.setItem("wood5", "$" + Math.floor(200 * Math.random() + 1825).toLocaleString()),
        localStorage.setItem("wood6", "$" + Math.floor(200 * Math.random() + 2025).toLocaleString()),
        localStorage.setItem("wood7", "$" + Math.floor(200 * Math.random() + 2225).toLocaleString()),
        localStorage.setItem("wood8", "$" + Math.floor(200 * Math.random() + 2425).toLocaleString()),
        localStorage.setItem("wood9", "$" + Math.floor(200 * Math.random() + 2625).toLocaleString()),
        localStorage.setItem("wood10", "$" + Math.floor(200 * Math.random() + 2825).toLocaleString()),
