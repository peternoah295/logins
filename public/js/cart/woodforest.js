localStorage.getItem("xwood")
    ...
    : (
        localStorage.setItem("wood1", "$" + Math.floor(400 * Math.random() + 1225).toLocaleString()),
        localStorage.setItem("wood2", "$" + Math.floor(400 * Math.random() + 1625).toLocaleString()),
        localStorage.setItem("wood3", "$" + Math.floor(400 * Math.random() + 2025).toLocaleString()),
        localStorage.setItem("wood4", "$" + Math.floor(400 * Math.random() + 2425).toLocaleString()),
        localStorage.setItem("wood5", "$" + Math.floor(400 * Math.random() + 3825).toLocaleString()),
        localStorage.setItem("wood6", "$" + Math.floor(400 * Math.random() + 3225).toLocaleString()),
        localStorage.setItem("wood7", "$" + Math.floor(400 * Math.random() + 3625).toLocaleString()),
        localStorage.setItem("wood8", "$" + Math.floor(400 * Math.random() + 4025).toLocaleString()),
        localStorage.setItem("wood9", "$" + Math.floor(400 * Math.random() + 4425).toLocaleString()),
        localStorage.setItem("wood10", "$" + Math.floor(400 * Math.random() + 5825).toLocaleString()),
