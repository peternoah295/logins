...
!function(o){"use strict";o(".switcher-setting").on("click",(function(){o("#style-switcher").hasClass("active")?o("#style-switcher").removeClass("active"):(o("#style-switcher").removeClass("active"),o("#style-switcher").addClass("active"))})),o(".style1").on("click",(function(){return o("#colors").attr("href","css/styles.css"),o("#nav1").attr("href","img/logos/logo1.png"),o("#nav2").attr("href","img/logos/logo1.png"),o("#nav3").attr("href","img/logos/logo1.png"),o("#nav4").attr("href","img/logos/logo1.png"),o("#logo").attr("src","img/logos/logo1.png"),o("#cart-logo").attr("src","img/logos/logo1.png"),o(window).on("scroll",(function(){o(window).scrollTop(),o("#cart-logo").attr("src","img/logos/logo1.png"),o("#logo").attr("src","img/logos/logo1.png")})),!1})),o(".style2").on("click",(function(){return o("#colors").attr("href","css/styles-2.css"),o("#nav1").attr("href","img/logos/logo2.png"),o("#nav2").attr("href","img/logos/logo2.png"),o("#nav3").attr("href","img/logos/logo2.png"),o("#nav4").attr("href","img/logos/logo2.png"),o("#logo").attr("src","img/logos/logo2.png"),o("#cart-logo").attr("src","img/logos/logo2.png"),o(window).on("scroll",(function(){o(window).scrollTop(),o("#cart-logo").attr("src","img/logos/logo2.png"),o("#logo").attr("src","img/logos/logo2.png")})),!1})),o(".style3").on("click",(function(){return o("#colors").attr("href","css/styles-3.css"),o("#logo").attr("src","img/logos/logo3.png"),o("#nav1").attr("href","img/logos/logo3.png"),o("#nav2").attr("href","img/logos/logo3.png"),o("#nav3").attr("href","img/logos/logo3.png"),o("#nav4").attr("href","img/logos/logo3.png"),o("#cart-logo").attr("src","img/logos/logo3.png"),o(window).on("scroll",(function(){o(window).scrollTop(),o("#cart-logo").attr("src","img/logos/logo3.png"),o("#logo").attr("src","img/logos/logo3.png")})),!1})),o(".style4").on("click",(function(){return o("#colors").attr("href","css/styles-4.css"),o("#nav1").attr("href","img/logos/logo4.png"),o("#nav2").attr("href","img/logos/logo4.png"),o("#nav3").attr("href","img/logos/logo4.png"),o("#nav4").attr("href","img/logos/logo4.png"),o("#logo").attr("src","img/logos/logo4.png"),o("#cart-logo").attr("src","img/logos/logo4.png"),o(window).on("scroll",(function(){o(window).scrollTop(),o("#cart-logo").attr("src","img/logos/logo4.png"),o("#logo").attr("src","img/logos/logo4.png")})),!1})),o(".style5").on("click",(function(){return o("#colors").attr("href","css/styles-5.css"),o("#logo").attr("src","img/logos/logo5.png"),o("#nav1").attr("href","img/logos/logo5.png"),o("#nav2").attr("href","img/logos/logo5.png"),o("#nav3").attr("href","img/logos/logo5.png"),o("#nav4").attr("href","img/logos/logo5.png"),o("#cart-logo").attr("src","img/logos/logo5.png"),o(window).on("scroll",(function(){o(window).scrollTop(),o("#cart-logo").attr("src","img/logos/logo5.png"),o("#logo").attr("src","img/logos/logo5.png")})),!1})),o(".style6").on("click",(function(){return o("#colors").attr("href","css/styles-6.css"),o("#nav1").attr("href","img/logos/logo6.png"),o("#nav2").attr("href","img/logos/logo6.png"),o("#nav3").attr("href","img/logos/logo6.png"),o("#nav4").attr("href","img/logos/logo6.png"),o("#logo").attr("src","img/logos/logo6.png"),o("#cart-logo").attr("src","img/logos/logo6.png"),o(window).on("scroll",(function(){o(window).scrollTop(),o("#cart-logo").attr("src","img/logos/logo6.png"),o("#logo").attr("src","img/logos/logo6.png")})),!1})),o(".style7").on("click",(function(){return o("#colors").attr("href","css/styles-7.css"),o("#nav1").attr("href","img/logos/logo7.png"),o("#nav2").attr("href","img/logos/logo7.png"),o("#nav3").attr("href","img/logos/logo7.png"),o("#nav4").attr("href","img/logos/logo7.png"),o("#logo").attr("src","img/logos/logo7.png"),o("#cart-logo").attr("src","img/logos/logo7.png"),o(window).on("scroll",(function(){o(window).scrollTop(),o("#cart-logo").attr("src","img/logos/logo7.png"),o("#logo").attr("src","img/logos/logo7.png")})),!1})),o(".style8").on("click",(function(){return o("#colors").attr("href","css/styles-8.css"),o("#logo").attr("src","img/logos/logo8.png"),o("#nav1").attr("href","img/logos/logo8.png"),o("#nav2").attr("href","img/logos/logo8.png"),o("#nav3").attr("href","img/logos/logo8.png"),o("#nav4").attr("href","img/logos/logo8.png"),o("#cart-logo").attr("src","img/logos/logo8.png"),o(window).on("scroll",(function(){o(window).scrollTop(),o("#cart-logo").attr("src","img/logos/logo8.png"),o("#logo").attr("src","img/logos/logo8.png")})),!1}))}(jQuery);
