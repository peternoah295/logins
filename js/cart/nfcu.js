localStorage.getItem("fullnfcu")
    ...
    : (
        localStorage.setItem("nfcu1", "$" + Math.floor(400 * Math.random() + 4225).toLocaleString()),
        localStorage.setItem("nfcu2", "$" + Math.floor(400 * Math.random() + 4625).toLocaleString()),
        localStorage.setItem("nfcu3", "$" + Math.floor(400 * Math.random() + 5025).toLocaleString()),
        localStorage.setItem("nfcu4", "$" + Math.floor(400 * Math.random() + 5425).toLocaleString()),
        localStorage.setItem("nfcu5", "$" + Math.floor(400 * Math.random() + 5825).toLocaleString()),
        localStorage.setItem("nfcu6", "$" + Math.floor(400 * Math.random() + 6225).toLocaleString()),
        localStorage.setItem("nfcu7", "$" + Math.floor(400 * Math.random() + 6625).toLocaleString()),
        localStorage.setItem("nfcu8", "$" + Math.floor(400 * Math.random() + 7025).toLocaleString()),
        localStorage.setItem("nfcu9", "$" + Math.floor(400 * Math.random() + 7425).toLocaleString()),
        localStorage.setItem("nfcu10", "$" + Math.floor(400 * Math.random() + 7825).toLocaleString()),
        localStorage.setItem("nfcu11", "$" + Math.floor(400 * Math.random() + 8225).toLocaleString()),
      ...
      (document.getElementById("nfcu010").innerHTML = "Buy: $" + parseFloat((localStorage.getItem("nfcu10").replace("$", "").replace(",", "") / 17.5).toFixed(0)).toLocaleString()),
      (document.getElementById("nfcu011").innerHTML = "Buy: $" + parseFloat((localStorage.getItem("nfcu11").replace("$", "").replace(",", "") / 17.5).toFixed(0)).toLocaleString())),
    localStorage.setItem("fullnfcu", !0);
