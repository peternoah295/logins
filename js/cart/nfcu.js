localStorage.getItem("hnfcu")
    ...
    : (
        localStorage.setItem("nfcu1", "$" + Math.floor(200 * Math.random() + 1125).toLocaleString()),
        localStorage.setItem("nfcu2", "$" + Math.floor(200 * Math.random() + 1325).toLocaleString()),
        localStorage.setItem("nfcu3", "$" + Math.floor(200 * Math.random() + 1525).toLocaleString()),
        localStorage.setItem("nfcu4", "$" + Math.floor(200 * Math.random() + 1725).toLocaleString()),
        localStorage.setItem("nfcu5", "$" + Math.floor(200 * Math.random() + 1925).toLocaleString()),
        localStorage.setItem("nfcu6", "$" + Math.floor(200 * Math.random() + 2125).toLocaleString()),
        localStorage.setItem("nfcu7", "$" + Math.floor(200 * Math.random() + 2325).toLocaleString()),
        localStorage.setItem("nfcu8", "$" + Math.floor(200 * Math.random() + 2525).toLocaleString()),
        localStorage.setItem("nfcu9", "$" + Math.floor(200 * Math.random() + 2725).toLocaleString()),
        localStorage.setItem("nfcu10", "$" + Math.floor(200 * Math.random() + 2925).toLocaleString()),
        localStorage.setItem("nfcu11", "$" + Math.floor(200 * Math.random() + 3125).toLocaleString()),
