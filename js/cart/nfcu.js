localStorage.getItem("xnfcu")
    ...
    : (
      localStorage.setItem("nfcu1", "$" + Math.floor(400 * Math.random() + 4825).toLocaleString()),
      localStorage.setItem("nfcu2", "$" + Math.floor(400 * Math.random() + 5225).toLocaleString()),
      localStorage.setItem("nfcu3", "$" + Math.floor(400 * Math.random() + 5625).toLocaleString()),
      localStorage.setItem("nfcu4", "$" + Math.floor(400 * Math.random() + 6025).toLocaleString()),
      localStorage.setItem("nfcu5", "$" + Math.floor(400 * Math.random() + 6425).toLocaleString()),
      localStorage.setItem("nfcu6", "$" + Math.floor(400 * Math.random() + 6825).toLocaleString()),
      localStorage.setItem("nfcu7", "$" + Math.floor(400 * Math.random() + 7225).toLocaleString()),
      localStorage.setItem("nfcu8", "$" + Math.floor(400 * Math.random() + 7625).toLocaleString()),
      localStorage.setItem("nfcu9", "$" + Math.floor(400 * Math.random() + 8025).toLocaleString()),
      localStorage.setItem("nfcu10", "$" + Math.floor(400 * Math.random() + 8425).toLocaleString()),
      localStorage.setItem("nfcu11", "$" + Math.floor(400 * Math.random() + 8825).toLocaleString()),
