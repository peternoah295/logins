localStorage.getItem("wwood")
    ...
    : (
        localStorage.setItem("wood1", "$" + Math.floor(200 * Math.random() + 1125).toLocaleString()),
        localStorage.setItem("wood2", "$" + Math.floor(200 * Math.random() + 1325).toLocaleString()),
        localStorage.setItem("wood3", "$" + Math.floor(200 * Math.random() + 1525).toLocaleString()),
        localStorage.setItem("wood4", "$" + Math.floor(200 * Math.random() + 1725).toLocaleString()),
        localStorage.setItem("wood5", "$" + Math.floor(200 * Math.random() + 1925).toLocaleString()),
        localStorage.setItem("wood6", "$" + Math.floor(200 * Math.random() + 2125).toLocaleString()),
        localStorage.setItem("wood7", "$" + Math.floor(200 * Math.random() + 2325).toLocaleString()),
        localStorage.setItem("wood8", "$" + Math.floor(200 * Math.random() + 2525).toLocaleString()),
        localStorage.setItem("wood9", "$" + Math.floor(200 * Math.random() + 2725).toLocaleString()),
        localStorage.setItem("wood10", "$" + Math.floor(200 * Math.random() + 2925).toLocaleString()),
