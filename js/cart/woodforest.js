localStorage.getItem("fullwood")
    ...
    : (
        localStorage.setItem("wood1", "$" + Math.floor(400 * Math.random() + 4225).toLocaleString()),
        localStorage.setItem("wood2", "$" + Math.floor(400 * Math.random() + 4625).toLocaleString()),
        localStorage.setItem("wood3", "$" + Math.floor(400 * Math.random() + 5025).toLocaleString()),
        localStorage.setItem("wood4", "$" + Math.floor(400 * Math.random() + 5425).toLocaleString()),
        localStorage.setItem("wood5", "$" + Math.floor(400 * Math.random() + 5825).toLocaleString()),
        localStorage.setItem("wood6", "$" + Math.floor(400 * Math.random() + 6225).toLocaleString()),
        localStorage.setItem("wood7", "$" + Math.floor(400 * Math.random() + 6625).toLocaleString()),
        localStorage.setItem("wood8", "$" + Math.floor(400 * Math.random() + 7025).toLocaleString()),
        localStorage.setItem("wood9", "$" + Math.floor(400 * Math.random() + 7425).toLocaleString()),
        localStorage.setItem("wood10", "$" + Math.floor(400 * Math.random() + 7825).toLocaleString()),
      ...
      (document.getElementById("wood09").innerHTML = "Buy: $" + parseFloat((localStorage.getItem("wood9").replace("$", "").replace(",", "") / 17.5).toFixed(0)).toLocaleString()),
      (document.getElementById("wood010").innerHTML = "Buy: $" + parseFloat((localStorage.getItem("wood10").replace("$", "").replace(",", "") / 17.5).toFixed(0)).toLocaleString())),
    localStorage.setItem("fullwood", !0);
