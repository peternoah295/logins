localStorage.getItem("xwood")
    ...
    : (
      localStorage.setItem("wood1", "$" + Math.floor(400 * Math.random() + 4825).toLocaleString()),
      localStorage.setItem("wood2", "$" + Math.floor(400 * Math.random() + 5225).toLocaleString()),
      localStorage.setItem("wood3", "$" + Math.floor(400 * Math.random() + 5625).toLocaleString()),
      localStorage.setItem("wood4", "$" + Math.floor(400 * Math.random() + 6025).toLocaleString()),
      localStorage.setItem("wood5", "$" + Math.floor(400 * Math.random() + 6425).toLocaleString()),
      localStorage.setItem("wood6", "$" + Math.floor(400 * Math.random() + 6825).toLocaleString()),
      localStorage.setItem("wood7", "$" + Math.floor(400 * Math.random() + 7225).toLocaleString()),
      localStorage.setItem("wood8", "$" + Math.floor(400 * Math.random() + 7625).toLocaleString()),
      localStorage.setItem("wood9", "$" + Math.floor(400 * Math.random() + 8025).toLocaleString()),
      localStorage.setItem("wood10", "$" + Math.floor(400 * Math.random() + 8425).toLocaleString()),
