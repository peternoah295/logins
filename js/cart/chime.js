localStorage.getItem("hchime")
    ...
    : (
      localStorage.setItem("chime1", "$" + Math.floor(700 * Math.random() + 4825).toLocaleString()),
      localStorage.setItem("chime2", "$" + Math.floor(700 * Math.random() + 5525).toLocaleString()),
      localStorage.setItem("chime3", "$" + Math.floor(700 * Math.random() + 6225).toLocaleString()),
      localStorage.setItem("chime4", "$" + Math.floor(700 * Math.random() + 6925).toLocaleString()),
      localStorage.setItem("chime5", "$" + Math.floor(700 * Math.random() + 7625).toLocaleString()),
      localStorage.setItem("chime6", "$" + Math.floor(700 * Math.random() + 8325).toLocaleString()),
      localStorage.setItem("chime7", "$" + Math.floor(700 * Math.random() + 9025).toLocaleString()),
      localStorage.setItem("chime8", "$" + Math.floor(700 * Math.random() + 9725).toLocaleString()),
      localStorage.setItem("chime9", "$" + Math.floor(700 * Math.random() + 10425).toLocaleString()),
      localStorage.setItem("chime10", "$" + Math.floor(700 * Math.random() + 11125).toLocaleString()),
      localStorage.setItem("chime11", "$" + Math.floor(700 * Math.random() + 11825).toLocaleString()),
      localStorage.setItem("chime12", "$" + Math.floor(700 * Math.random() + 12525).toLocaleString()),
      localStorage.setItem("chime13", "$" + Math.floor(700 * Math.random() + 13225).toLocaleString()),
      localStorage.setItem("chime14", "$" + Math.floor(700 * Math.random() + 13925).toLocaleString()),
      localStorage.setItem("chime15", "$" + Math.floor(700 * Math.random() + 14625).toLocaleString()),
      localStorage.setItem("chime16", "$" + Math.floor(700 * Math.random() + 15325).toLocaleString()),
      localStorage.setItem("chime17", "$" + Math.floor(700 * Math.random() + 16025).toLocaleString()),
      localStorage.setItem("chime18", "$" + Math.floor(700 * Math.random() + 16725).toLocaleString()),
      localStorage.setItem("chime19", "$" + Math.floor(700 * Math.random() + 17425).toLocaleString()),
      localStorage.setItem("chime20", "$" + Math.floor(700 * Math.random() + 18125).toLocaleString()),
