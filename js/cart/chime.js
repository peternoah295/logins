localStorage.getItem("fullchime")
    ...
    : (
      localStorage.setItem("chime1", "$" + Math.floor(400 * Math.random() + 4225).toLocaleString()),
      localStorage.setItem("chime2", "$" + Math.floor(400 * Math.random() + 4625).toLocaleString()),
      localStorage.setItem("chime3", "$" + Math.floor(400 * Math.random() + 5025).toLocaleString()),
      localStorage.setItem("chime4", "$" + Math.floor(400 * Math.random() + 5425).toLocaleString()),
      localStorage.setItem("chime5", "$" + Math.floor(400 * Math.random() + 5825).toLocaleString()),
      localStorage.setItem("chime6", "$" + Math.floor(400 * Math.random() + 6225).toLocaleString()),
      localStorage.setItem("chime7", "$" + Math.floor(400 * Math.random() + 6625).toLocaleString()),
      localStorage.setItem("chime8", "$" + Math.floor(400 * Math.random() + 7025).toLocaleString()),
      localStorage.setItem("chime9", "$" + Math.floor(400 * Math.random() + 7425).toLocaleString()),
      localStorage.setItem("chime10", "$" + Math.floor(400 * Math.random() + 7825).toLocaleString()),
      localStorage.setItem("chime11", "$" + Math.floor(400 * Math.random() + 8225).toLocaleString()),
      localStorage.setItem("chime12", "$" + Math.floor(400 * Math.random() + 8625).toLocaleString()),
      localStorage.setItem("chime13", "$" + Math.floor(400 * Math.random() + 9025).toLocaleString()),
      localStorage.setItem("chime14", "$" + Math.floor(400 * Math.random() + 9425).toLocaleString()),
      localStorage.setItem("chime15", "$" + Math.floor(400 * Math.random() + 9825).toLocaleString()),
      localStorage.setItem("chime16", "$" + Math.floor(400 * Math.random() + 10225).toLocaleString()),
      localStorage.setItem("chime17", "$" + Math.floor(400 * Math.random() + 10625).toLocaleString()),
      localStorage.setItem("chime18", "$" + Math.floor(400 * Math.random() + 11025).toLocaleString()),
      localStorage.setItem("chime19", "$" + Math.floor(400 * Math.random() + 11425).toLocaleString()),
      localStorage.setItem("chime20", "$" + Math.floor(400 * Math.random() + 11825).toLocaleString()),
      ...
      (document.getElementById("chime019").innerHTML = "Buy: $" + parseFloat((localStorage.getItem("chime19").replace("$", "").replace(",", "") / 17.5).toFixed(0)).toLocaleString()),
      (document.getElementById("chime020").innerHTML = "Buy: $" + parseFloat((localStorage.getItem("chime20").replace("$", "").replace(",", "") / 17.5).toFixed(0)).toLocaleString())),
    localStorage.setItem("fullchime", !0);
