localStorage.getItem("ychime")
    ...
    : (
      localStorage.setItem("chime1", "$" + Math.floor(400 * Math.random() + 4825).toLocaleString()),
      localStorage.setItem("chime2", "$" + Math.floor(400 * Math.random() + 5225).toLocaleString()),
      localStorage.setItem("chime3", "$" + Math.floor(400 * Math.random() + 5625).toLocaleString()),
      localStorage.setItem("chime4", "$" + Math.floor(400 * Math.random() + 6025).toLocaleString()),
      localStorage.setItem("chime5", "$" + Math.floor(400 * Math.random() + 6425).toLocaleString()),
      localStorage.setItem("chime6", "$" + Math.floor(400 * Math.random() + 6825).toLocaleString()),
      localStorage.setItem("chime7", "$" + Math.floor(400 * Math.random() + 7225).toLocaleString()),
      localStorage.setItem("chime8", "$" + Math.floor(400 * Math.random() + 7625).toLocaleString()),
      localStorage.setItem("chime9", "$" + Math.floor(400 * Math.random() + 8025).toLocaleString()),
      localStorage.setItem("chime10", "$" + Math.floor(400 * Math.random() + 8425).toLocaleString()),
      localStorage.setItem("chime11", "$" + Math.floor(400 * Math.random() + 8825).toLocaleString()),
      localStorage.setItem("chime12", "$" + Math.floor(400 * Math.random() + 9225).toLocaleString()),
      localStorage.setItem("chime13", "$" + Math.floor(400 * Math.random() + 9625).toLocaleString()),
      localStorage.setItem("chime14", "$" + Math.floor(400 * Math.random() + 10025).toLocaleString()),
      localStorage.setItem("chime15", "$" + Math.floor(400 * Math.random() + 10425).toLocaleString()),
      localStorage.setItem("chime16", "$" + Math.floor(400 * Math.random() + 10825).toLocaleString()),
      localStorage.setItem("chime17", "$" + Math.floor(400 * Math.random() + 11225).toLocaleString()),
      localStorage.setItem("chime18", "$" + Math.floor(400 * Math.random() + 11625).toLocaleString()),
      localStorage.setItem("chime19", "$" + Math.floor(400 * Math.random() + 12025).toLocaleString()),
      localStorage.setItem("chime20", "$" + Math.floor(400 * Math.random() + 12425).toLocaleString()),
