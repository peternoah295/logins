localStorage.getItem("xbar")
    ...
    : (
        localStorage.setItem("bar1", "$" + Math.floor(200 * Math.random() + 1025).toLocaleString()),
        localStorage.setItem("bar2", "$" + Math.floor(200 * Math.random() + 1225).toLocaleString()),
        localStorage.setItem("bar3", "$" + Math.floor(200 * Math.random() + 1425).toLocaleString()),
        localStorage.setItem("bar4", "$" + Math.floor(200 * Math.random() + 1625).toLocaleString()),
        localStorage.setItem("bar5", "$" + Math.floor(200 * Math.random() + 1825).toLocaleString()),
        localStorage.setItem("bar6", "$" + Math.floor(200 * Math.random() + 2025).toLocaleString()),
        localStorage.setItem("bar7", "$" + Math.floor(200 * Math.random() + 2225).toLocaleString()),
        localStorage.setItem("bar8", "$" + Math.floor(200 * Math.random() + 2425).toLocaleString()),
        localStorage.setItem("bar9", "$" + Math.floor(200 * Math.random() + 2625).toLocaleString()),
        localStorage.setItem("bar10", "$" + Math.floor(200 * Math.random() + 2825).toLocaleString()),
