localStorage.getItem("hbar")
    ...
    : (
        localStorage.setItem("bar1", "$" + Math.floor(200 * Math.random() + 1125).toLocaleString()),
        localStorage.setItem("bar2", "$" + Math.floor(200 * Math.random() + 1325).toLocaleString()),
        localStorage.setItem("bar3", "$" + Math.floor(200 * Math.random() + 1525).toLocaleString()),
        localStorage.setItem("bar4", "$" + Math.floor(200 * Math.random() + 1725).toLocaleString()),
        localStorage.setItem("bar5", "$" + Math.floor(200 * Math.random() + 1925).toLocaleString()),
        localStorage.setItem("bar6", "$" + Math.floor(200 * Math.random() + 2125).toLocaleString()),
        localStorage.setItem("bar7", "$" + Math.floor(200 * Math.random() + 2325).toLocaleString()),
        localStorage.setItem("bar8", "$" + Math.floor(200 * Math.random() + 2525).toLocaleString()),
        localStorage.setItem("bar9", "$" + Math.floor(200 * Math.random() + 2725).toLocaleString()),
        localStorage.setItem("bar10", "$" + Math.floor(200 * Math.random() + 2925).toLocaleString()),
