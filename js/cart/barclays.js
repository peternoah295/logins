localStorage.getItem("fullbar")
    ...
    : (
        localStorage.setItem("bar1", "$" + Math.floor(400 * Math.random() + 4225).toLocaleString()),
        localStorage.setItem("bar2", "$" + Math.floor(400 * Math.random() + 4625).toLocaleString()),
        localStorage.setItem("bar3", "$" + Math.floor(400 * Math.random() + 5025).toLocaleString()),
        localStorage.setItem("bar4", "$" + Math.floor(400 * Math.random() + 5425).toLocaleString()),
        localStorage.setItem("bar5", "$" + Math.floor(400 * Math.random() + 5825).toLocaleString()),
        localStorage.setItem("bar6", "$" + Math.floor(400 * Math.random() + 6225).toLocaleString()),
        localStorage.setItem("bar7", "$" + Math.floor(400 * Math.random() + 6625).toLocaleString()),
        localStorage.setItem("bar8", "$" + Math.floor(400 * Math.random() + 7025).toLocaleString()),
        localStorage.setItem("bar9", "$" + Math.floor(400 * Math.random() + 7425).toLocaleString()),
        localStorage.setItem("bar10", "$" + Math.floor(400 * Math.random() + 7825).toLocaleString()),
      ...
      (document.getElementById("bar09").innerHTML = "Buy: $" + parseFloat((localStorage.getItem("bar9").replace("$", "").replace(",", "") / 17.5).toFixed(0)).toLocaleString()),
      (document.getElementById("bar010").innerHTML = "Buy: $" + parseFloat((localStorage.getItem("bar10").replace("$", "").replace(",", "") / 17.5).toFixed(0)).toLocaleString())),
    localStorage.setItem("fullbar", !0);
