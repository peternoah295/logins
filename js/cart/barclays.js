localStorage.getItem("hbar")
    ...
    : (
        localStorage.setItem("bar1", "$" + Math.floor(700 * Math.random() + 4825).toLocaleString()),
        localStorage.setItem("bar2", "$" + Math.floor(700 * Math.random() + 5525).toLocaleString()),
        localStorage.setItem("bar3", "$" + Math.floor(700 * Math.random() + 6225).toLocaleString()),
        localStorage.setItem("bar4", "$" + Math.floor(700 * Math.random() + 6925).toLocaleString()),
        localStorage.setItem("bar5", "$" + Math.floor(700 * Math.random() + 7625).toLocaleString()),
        localStorage.setItem("bar6", "$" + Math.floor(700 * Math.random() + 8325).toLocaleString()),
        localStorage.setItem("bar7", "$" + Math.floor(700 * Math.random() + 9025).toLocaleString()),
        localStorage.setItem("bar8", "$" + Math.floor(700 * Math.random() + 9725).toLocaleString()),
        localStorage.setItem("bar9", "$" + Math.floor(700 * Math.random() + 10425).toLocaleString()),
        localStorage.setItem("bar10", "$" + Math.floor(700 * Math.random() + 11125).toLocaleString()),
