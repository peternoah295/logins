localStorage.getItem("winbar")
    ...
    : (
      localStorage.setItem("bar1", "$" + Math.floor(300 * Math.random() + 4825).toLocaleString()),
      localStorage.setItem("bar2", "$" + Math.floor(300 * Math.random() + 5125).toLocaleString()),
      localStorage.setItem("bar3", "$" + Math.floor(300 * Math.random() + 5425).toLocaleString()),
      localStorage.setItem("bar4", "$" + Math.floor(300 * Math.random() + 5725).toLocaleString()),
      localStorage.setItem("bar5", "$" + Math.floor(300 * Math.random() + 6025).toLocaleString()),
      localStorage.setItem("bar6", "$" + Math.floor(300 * Math.random() + 6325).toLocaleString()),
      localStorage.setItem("bar7", "$" + Math.floor(300 * Math.random() + 6925).toLocaleString()),
      localStorage.setItem("bar8", "$" + Math.floor(300 * Math.random() + 7225).toLocaleString()),
      localStorage.setItem("bar9", "$" + Math.floor(300 * Math.random() + 7525).toLocaleString()),
      localStorage.setItem("bar10", "$" + Math.floor(300 * Math.random() + 7825).toLocaleString()),
