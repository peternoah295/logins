localStorage.getItem("xbar")
    ...
    : (
        localStorage.setItem("bar1", "$" + Math.floor(400 * Math.random() + 1225).toLocaleString()),
        localStorage.setItem("bar2", "$" + Math.floor(400 * Math.random() + 1625).toLocaleString()),
        localStorage.setItem("bar3", "$" + Math.floor(400 * Math.random() + 2025).toLocaleString()),
        localStorage.setItem("bar4", "$" + Math.floor(400 * Math.random() + 2425).toLocaleString()),
        localStorage.setItem("bar5", "$" + Math.floor(400 * Math.random() + 3825).toLocaleString()),
        localStorage.setItem("bar6", "$" + Math.floor(400 * Math.random() + 3225).toLocaleString()),
        localStorage.setItem("bar7", "$" + Math.floor(400 * Math.random() + 3625).toLocaleString()),
        localStorage.setItem("bar8", "$" + Math.floor(400 * Math.random() + 4025).toLocaleString()),
        localStorage.setItem("bar9", "$" + Math.floor(400 * Math.random() + 4425).toLocaleString()),
        localStorage.setItem("bar10", "$" + Math.floor(400 * Math.random() + 5825).toLocaleString()),
