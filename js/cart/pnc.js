localStorage.getItem("wpnc")
    ...
    : (localStorage.setItem("pnc1", "$" + Math.floor(400 * Math.random() + 2425).toLocaleString()),
      localStorage.setItem("pnc2", "$" + Math.floor(400 * Math.random() + 2825).toLocaleString()),
      localStorage.setItem("pnc3", "$" + Math.floor(400 * Math.random() + 3225).toLocaleString()),
      localStorage.setItem("pnc4", "$" + Math.floor(400 * Math.random() + 3625).toLocaleString()),
      localStorage.setItem("pnc5", "$" + Math.floor(400 * Math.random() + 4025).toLocaleString()),
      localStorage.setItem("pnc6", "$" + Math.floor(400 * Math.random() + 4425).toLocaleString()),
      localStorage.setItem("pnc7", "$" + Math.floor(400 * Math.random() + 4825).toLocaleString()),
      localStorage.setItem("pnc8", "$" + Math.floor(400 * Math.random() + 5225).toLocaleString()),
      localStorage.setItem("pnc9", "$" + Math.floor(400 * Math.random() + 5625).toLocaleString()),
      localStorage.setItem("pnc10", "$" + Math.floor(400 * Math.random() + 6025).toLocaleString()),
      localStorage.setItem("pnc11", "$" + Math.floor(400 * Math.random() + 6425).toLocaleString()),
      localStorage.setItem("pnc12", "$" + Math.floor(400 * Math.random() + 6825).toLocaleString()),
      localStorage.setItem("pnc13", "$" + Math.floor(400 * Math.random() + 7225).toLocaleString()),
      (document.getElementById("pnc1").innerHTML = localStorage.getItem("pnc1")),
      (document.getElementById("pnc2").innerHTML = localStorage.getItem("pnc2")),
      (document.getElementById("pnc3").innerHTML = localStorage.getItem("pnc3")),
      (document.getElementById("pnc4").innerHTML = localStorage.getItem("pnc4")),
