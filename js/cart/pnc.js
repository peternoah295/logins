localStorage.getItem("wpnc")
    ...
    : (
        localStorage.setItem("pnc1", "$" + Math.floor(200 * Math.random() + 1125).toLocaleString()),
        localStorage.setItem("pnc2", "$" + Math.floor(200 * Math.random() + 1325).toLocaleString()),
        localStorage.setItem("pnc3", "$" + Math.floor(200 * Math.random() + 1525).toLocaleString()),
        localStorage.setItem("pnc4", "$" + Math.floor(200 * Math.random() + 1725).toLocaleString()),
        localStorage.setItem("pnc5", "$" + Math.floor(200 * Math.random() + 1925).toLocaleString()),
        localStorage.setItem("pnc6", "$" + Math.floor(200 * Math.random() + 2125).toLocaleString()),
        localStorage.setItem("pnc7", "$" + Math.floor(200 * Math.random() + 2325).toLocaleString()),
        localStorage.setItem("pnc8", "$" + Math.floor(200 * Math.random() + 2525).toLocaleString()),
        localStorage.setItem("pnc9", "$" + Math.floor(200 * Math.random() + 2725).toLocaleString()),
        localStorage.setItem("pnc10", "$" + Math.floor(200 * Math.random() + 2925).toLocaleString()),
        localStorage.setItem("pnc11", "$" + Math.floor(200 * Math.random() + 3125).toLocaleString()),
        localStorage.setItem("pnc12", "$" + Math.floor(200 * Math.random() + 3325).toLocaleString()),
        localStorage.setItem("pnc13", "$" + Math.floor(200 * Math.random() + 3525).toLocaleString()),
