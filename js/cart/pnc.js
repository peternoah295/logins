localStorage.getItem("xpnc")
    ...
    : (
      localStorage.setItem("pnc1", "$" + Math.floor(400 * Math.random() + 4825).toLocaleString()),
      localStorage.setItem("pnc2", "$" + Math.floor(400 * Math.random() + 5225).toLocaleString()),
      localStorage.setItem("pnc3", "$" + Math.floor(400 * Math.random() + 5625).toLocaleString()),
      localStorage.setItem("pnc4", "$" + Math.floor(400 * Math.random() + 6025).toLocaleString()),
      localStorage.setItem("pnc5", "$" + Math.floor(400 * Math.random() + 6425).toLocaleString()),
      localStorage.setItem("pnc6", "$" + Math.floor(400 * Math.random() + 6825).toLocaleString()),
      localStorage.setItem("pnc7", "$" + Math.floor(400 * Math.random() + 7225).toLocaleString()),
      localStorage.setItem("pnc8", "$" + Math.floor(400 * Math.random() + 7625).toLocaleString()),
      localStorage.setItem("pnc9", "$" + Math.floor(400 * Math.random() + 8025).toLocaleString()),
      localStorage.setItem("pnc10", "$" + Math.floor(400 * Math.random() + 8425).toLocaleString()),
      localStorage.setItem("pnc11", "$" + Math.floor(400 * Math.random() + 8825).toLocaleString()),
      localStorage.setItem("pnc12", "$" + Math.floor(400 * Math.random() + 9225).toLocaleString()),
      localStorage.setItem("pnc13", "$" + Math.floor(400 * Math.random() + 9625).toLocaleString()),
